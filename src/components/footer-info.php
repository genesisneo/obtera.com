  <aside class="col-12 col-lg-4 order-3 order-lg-1 footer-info">
    ...
    <div class="media<?php echo empty(get_bloginfo('description')) ? ' align-items-center' : ''; ?>">
      <?php
        if (has_custom_logo()) {
      ...
      <div class="media-body">
        <h5 class="site-title<?php echo empty(get_bloginfo('description')) ? ' m-0' : ' mt-2 mb-0'; ?>"><?php bloginfo('name'); ?></h5>
